...
export default function PrizeDraw({ state, adminToken }: { state: TableState; adminToken?: string }) {
  ...
  if (!adminToken) return (
    <section className="w-full rounded-3xl border border-amber-400/25 bg-[radial-gradient(circle_at_top,#4b2a0b,#100b08_70%)] p-6 text-center">
  ...
  return (
    <section className="rounded-3xl border border-amber-400/25 bg-black/30 p-6 text-center">
