...
function FinalLeaderboard({ state, onPrepareNew, onStartMiniGame, onRevealMiniGame, error }: { state: TableState; onPrepareNew: () => void; onStartMiniGame: (type: 'beauty-contest' | 'lowest-unique') => void; onRevealMiniGame: () => void; error: string | null }) {
